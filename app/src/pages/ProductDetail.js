                ...
                {allImages.length > 1 && (
                  <div className="flex lg:flex-col gap-2 lg:gap-3 order-2 lg:order-1">
                    {allImages.map((img, index) => (
                      <div
                        key={index}
                        className={`flex-shrink-0 aspect-[3/4] w-16 h-20 lg:w-20 lg:h-28 cursor-pointer overflow-hidden bg-black border-2 transition-all ${selectedImage === index
              ...
              <div className="lg:col-span-1">
                ...
                <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-4">
                  ...
                  <button
                    ...
                    className={`w-full rounded-sm bg-white px-4 py-2.5 text-xs font-medium uppercase tracking-[0.1em] text-black transition-all hover:bg-white/90 sm:w-auto sm:flex-1 sm:px-6 sm:py-2 sm:text-sm sm:tracking-[0.15em] ${isAddingToCart ? 'animate-pulse scale-95' : ''
                      }`}
                  >
              ...
              <div className="grid gap-6 lg:grid-cols-3 lg:gap-8">
                ...
                <div className="lg:col-span-1">
                  ...
                  <button
                    ...
                    className={`rounded-sm bg-white px-6 py-2 text-sm font-medium uppercase tracking-[0.15em] text-black transition-all hover:bg-white/90 ${isAddingToCart ? 'animate-pulse scale-95' : ''
                      }`}
                  >
                    {isAddingToCart ? 'Añadiendo...' : 'Añadir al carrito'}
                  </button>
                ...
                <div>
                  ...
                  <div className="mb-4 flex items-center gap-4">
                    ...
                    <button
                      ...
                      className={`flex-1 rounded-sm bg-white px-6 py-2 text-sm font-medium uppercase tracking-[0.15em] text-black transition-all hover:bg-white/90 ${isAddingToCart ? 'animate-pulse scale-95' : ''
                        }`}
                    >
                      {isAddingToCart ? 'Añadiendo...' : 'Añadir al carrito'}
                    </button>
