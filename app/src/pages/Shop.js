              ...
              <div className="mb-8 sm:mb-12">
                <div className="flex flex-wrap items-center gap-2 sm:gap-3">
                  <button
                    ...
                    className={`px-4 py-2 text-xs uppercase tracking-[0.15em] transition-all sm:px-6 sm:py-2.5 sm:text-sm sm:tracking-[0.2em] ${!selectedCategory
                  ...
                  {Object.values(categories).map((category) => (
                    <button
                      ...
                      className={`px-4 py-2 text-xs uppercase tracking-[0.15em] transition-all sm:px-6 sm:py-2.5 sm:text-sm sm:tracking-[0.2em] ${selectedCategory === category.id
                          ? "border border-white bg-white text-black"
                          : "border border-white/20 bg-black/50 text-white hover:border-white/40"
                        }`}
                    >
